...
import {useAddBookCopyMutation, useUpdateBookCopyMutation} from "../../../../features/book/bookApi.ts";
import {Toaster} from "../../../ui/toaster.tsx";
import {toaster} from "../../../toaster/toasterInstance.tsx";

// Enums for set values of fields
...
interface BookFormProps {
    mode: "add" | "edit";
    initialData?: Partial<FormValues>; // used for edit mode
...
export const BookForm = ({ mode, initialData, onSubmitSuccess, bookId }: BookFormProps) => {
    ...
    const [updateBookCopy] = useUpdateBookCopyMutation(); // you will create this
    ...
    const onSubmit: SubmitHandler<FormValues> = async (data) => {
        try {
            ...
            toaster.create({
                ...
                description:
                    mode === "add"
                        ? `Le livre "${bookData.title}" a été ajouté.`
                        : `Le livre "${bookData.title}" a été mis à jour.`,
                type: "success",
                closable: true,
            });
            ...
            // Reset form
            if (mode === "add") handleReset();
        } catch (error) {
            console.error('Failed to add book:', error);
            toaster.create({
                title: "Erreur",
                description:  mode === "add"
                    ? "Échec de l'ajout du livre."
